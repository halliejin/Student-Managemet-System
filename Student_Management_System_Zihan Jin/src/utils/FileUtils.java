...
/**
 * This is the db of all information about people and courses
...
public class FileUtils {
    ...
    public void setUp(String studentInfo, String profInfo, String adminInfo, String courseInfo) {
        ...
        try {
            ...
            while (true) {
                ...
                // load grades
                if (array.length > 4) {
                    // if this student has some course which is taken, add it
                ...
                // if this student is a new student without courses taken, return
    ...
    public boolean addNewProf(String id, String name, String userName, String passWord) {
        ...
        // else create a new prof in the db:
