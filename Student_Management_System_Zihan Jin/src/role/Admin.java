...
public class Admin extends User {
    ...
    public int deleteStudent(FileUtils db, String mode) {
        ...
        while (true) {
            ...
            boolean flag = true;
            for (Student student1 : db.getStudentsInfo()) {
            ...
            if (student == null) {
                ...
                // 2. deleted the student from the db
                db.getStudentsInfo().remove(student);
    ...
    public int addNewStudent(FileUtils db, String mode) {
        Scanner sc = new Scanner(System.in);
        ...
        while (true) {
            ...
            while (true) {
                ...
                db.addNewStudent(studentID, studentName, studentUserName, studentPassword);
                return 1;
            }
        }
    ...
    public int deleteProf(FileUtils db, String mode) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (prof == null) {
                    ...
                    for (Course course : list) {
                        deleteCourse(db, db.getStudentsInfo(), prof.getName(), course);
                    }

                    // 2. delete the prof in db:
                    db.getProfessorsInfo().remove(prof);
     ...
     *
     */
    public Professor addNewProf(FileUtils db, String mode) {
        Professor prof = null;
        Scanner sc = new Scanner(System.in);
        ...
        while (true) {
            ...
            // create a new prof
            if (db.addNewProf(profID, profName, profUserName, profPassword)) {
     ...
     * otherwise false
     */
    public boolean deleteCourse(FileUtils db, List<Student> students, String profName, Course course) {
        // find the instructor
        Professor professor = null;
        for (Professor prof : db.getProfessorsInfo()) {
        ...
        if (db.getCourseInfo().contains(course)) {
            db.getCourseInfo().remove(course);
        }
